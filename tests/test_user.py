...
class TestUsers:
    ...
    def test_get_user_by_id(self, create_test_user1):
        res = client.get("/users")
        assert res.status_code == 200
        data = json.loads(res.data)
        assert data[0]["username"] == create_test_user1.username

    def test_get_user_not_found_by_id(self, db_create):
        res = client.get("/users/1")
        assert res.status_code == 404
        data = json.loads(res.data)
        assert data["error"] == "No user with id=1"

    def test_get_users(self, db_create, create_test_user1_and_user2):
        res = client.get("/users")
        assert res.status_code == 200
        data = json.loads(res.data)
    ...
    def test_get_users_not_found(self, db_create):
        res = client.get("/users")
        assert res.status_code == 404
        data = json.loads(res.data)
        assert data["error"] == "No users yet"

    def test_post_user_creation(self, db_create):
        user_data = {
            "username": 'user',
            'password': 'user'
        }
    ...
    def test_post_user_creation_the_same_username(self, db_create, create_test_user1):
        new_user_data = {
            "username": 'user1',
            'password': 'user1'
        }
    ...
    def test_put_user_by_id(self, db_create, create_test_user1):
        user_data_to_change = {
            "username": 'admin1'
        }
    ...
    def test_put_user_by_id_not_found(self, db_create):
        user_data_to_change = {
            "username": 'admin1'
        }
    ...
    def test_put_user_by_id_change_to_the_same_username(self, db_create, create_test_user1_and_user2):
        user_data_to_change = {
            "username": 'user1'
        }
